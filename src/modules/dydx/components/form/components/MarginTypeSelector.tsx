...
//               {/* Slider + Input in same row — matching screenshot layout */}
...
//                 {/* Input box */}
//                 <div className="relative flex items-center bg-(--color-bg-primary) border border-(--color-border) rounded-lg focus-within:border-indigo-500 transition-colors">
//                   <input
//                     type="text"
//                     inputMode="numeric"
//                     value={inputValue}
//                     onKeyDown={e => {
//                       // Block: decimal point, minus, e, E, +, and any non-digit except control keys
//                       if (
//                         e.key === '.' ||
//                         e.key === ',' ||
//                         e.key === '-' ||
