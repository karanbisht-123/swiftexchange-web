    ...
    <>
      <div className="flex items-center justify-between px-2 py-2 border-b border-color md:px-4 ">
        ...
        <button
          ...
          className="px-2 md:px-3 py-1 md:py-1.5 text-[10px] md:text-xs font-bold text-(--color-text-primary) bg-(--color-bg-tertiary) border border-(--color-border) rounded-md hover:bg-(--color-bg-hover) transition-all flex items-center gap-1"
        >
          {Math.round(leverage)}×
        </button>
      </div>
          ...
          <div className="bg-(--color-bg-secondary) border border-(--color-border) rounded-2xl w-[360px] shadow-2xl">
            ...
            <div className="px-5 py-5 space-y-6">
              <div className="flex items-center gap-3">
                <div className="w-7 h-7 rounded-full bg-(--color-bg-tertiary) border border-(--color-border) flex items-center justify-center overflow-hidden">
              ...
              <div className="relative flex items-center h-10">
                ...
                <input
                  ...
                  value={tempLeverage}
                  onChange={e => {
                    setTempLeverage(parseFloat(e.target.value));
              ...
              <div className="flex items-center justify-center">
                <div className="relative rounded-lg flex items-center bg-(--color-bg-primary) border border-(--color-border) focus-within:border-indigo-500 transition-colors">
                  <input
                    type="number"
                    value={inputValue}
                    onChange={e => {
                    ...
                    className="w-16 h-10 bg-transparent text-center text-(--color-text-primary) font-mono text-lg font-bold focus:outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                  />
                  <span className="text-(--color-text-secondary) pr-3 text-sm font-bold">×</span>
                </div>
              </div>
