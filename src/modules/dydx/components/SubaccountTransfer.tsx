    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-gray-900 rounded-xl border border-gray-700 w-full max-w-md shadow-2xl">
        ...
        <div className="p-4 space-y-4">
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-500">
              Available:{' '}
              <span className="text-green-400 font-medium">${sourceBalance.toFixed(2)}</span>
            </p>
          </div>
        ...
        <div className="p-4 border-t border-gray-700">
          ...
          <p className="text-xs text-gray-500 text-center mt-2">Gas fees will be paid in USDC</p>
        </div>
      </div>
    </div>
  );
