      ...
      <div className="space-y-4">
        <div className="grid grid-cols-2 gap-4">
          <DetailItem label="Type">
            <span className="px-2 py-1 bg-secondary text-primary rounded text-xs">{fill.type}</span>
          </DetailItem>
        ...
        <div className="space-y-3">
          ...
          <DetailItem label="Fill ID">
            <div className="flex items-center gap-2">
              <span className="text-muted text-xs font-mono truncate max-w-[150px]">{fill.id}</span>
              <button
          ...
          {fill.orderId && (
            <DetailItem label="Order ID">
              <span className="text-muted text-xs font-mono truncate">{fill.orderId}</span>
            </DetailItem>
          )}
        </div>
      </div>
