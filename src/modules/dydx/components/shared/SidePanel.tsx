...
export const SidePanel: React.FC<SidePanelProps> = ({
  ...
  return createPortal(
    ...
    >
      ...
      <div
        ref={panelRef}
        className={`absolute top-0 right-0 h-full ${widthClasses[width]} max-w-[90vw] bg-primary border-l border-color shadow-2xl flex flex-col transform transition-transform duration-300 ease-out ${
