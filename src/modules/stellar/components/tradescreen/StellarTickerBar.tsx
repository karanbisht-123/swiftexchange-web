...
export const StellarTickerBar: React.FC = () => {
  ...
  if (loading || tickerData.length === 0) {
    return (
      <div className="w-full bg-secondary/50 border-b border-divider overflow-hidden select-none relative h-9 flex items-center justify-center">
        <span className="text-[10px] font-bold text-muted uppercase tracking-widest animate-pulse">
  ...
  return (
    <div className="w-full lg:max-w-[93vw] rounded-md mx-auto bg-secondary/50 mb-1 lg:mb-2 overflow-hidden select-none relative h-9 flex items-center">
      {/* Scrollable Track */}
      <div className="flex whitespace-nowrap animate-ticker hover:[animation-play-state:paused] cursor-pointer">
        {duplicatedTickers.map((item, index) => (
          <div
            ...
            className="inline-flex items-center gap-2 px-6 py-1.5 text-[11px] font-semibold transition-all hover:bg-white/5 border-r border-divider/40"
          >
