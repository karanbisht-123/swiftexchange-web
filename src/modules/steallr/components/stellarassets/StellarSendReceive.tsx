...
const StellarSendReceive: React.FC<StellarSendReceiveProps> = ({
    asset,
    userAddress,
    onBack,
}) => {
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            const sendAsset = asset.ticker === 'XLM'
                ? Asset.native()
                : new Asset(asset.ticker, asset.issuer || '');
        ...
        <div className="bg-secondary max-w-[90vw] w-full rounded-xl shadow-sm flex flex-col h-full min-h-[500px]">
            ...
            <div className="flex border-b border-color bg-secondary">
                <button
                    ...
                    className={`flex-1 py-3 text-sm font-medium transition-colors ${activeTab === 'send'
                ...
                <button
                    ...
                    className={`flex-1 py-3 text-sm font-medium transition-colors ${activeTab === 'receive'
                        ? 'border-b-2 border-brand-primary text-brand-primary'
                        : 'text-muted hover:text-primary'
                        }`}
                >
