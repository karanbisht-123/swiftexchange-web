...
import { ChevronRight, Plus, Search, Loader2, AlertCircle, CheckCircle2 } from 'lucide-react';
...
const UnifiedAssets: React.FC<UnifiedAssetsProps> = ({ userAddress, onAssetClick }) => {
    ...
    return (
        <div className="bg-secondary max-w-[90vw] w-full rounded-2xl shadow-lg flex flex-col min-h-[600px] overflow-hidden border border-color">
            <div className="p-6 border-b border-color bg-gradient-to-br from-tertiary to-secondary sticky top-0 z-10">
                        ...
                        {displayedAssets.map((asset, i) => {
                            ...
                            return (
                                <div
                                    ...
                                    className={`
                                        flex items-center justify-between px-6 py-5 border-b border-color 
