...
import { Loader2, ArrowUpRight, ArrowDownLeft, Clock, SearchX, CheckCircle, XCircle, Trash2, RefreshCw } from 'lucide-react';
        ...
        if (historyData.length === 0) {
            return (
                <div className="flex flex-col items-center justify-center py-20 text-center">
                    ...
                    <p className="text-muted text-sm max-w-xs">You haven't made any transactions on the {selectedView === 'bsc' ? 'BNB' : 'ETH'} network yet.</p>
                </div>
            );
        }
