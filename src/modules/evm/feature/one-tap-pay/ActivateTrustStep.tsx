...
const ActivateTrustStep: React.FC<ActivateTrustStepProps> = ({ onComplete, onSkip }) => {
  ...
  return (
    <StellarActiveGuard onSkip={handleRemindMeLater}>
      <div className="text-center space-y-6 animate-slide-up">
        <div className="flex justify-center items-center my-6">
          {/* <div className="p-6 rounded-full bg-info-bg relative overflow-hidden">
            ...
            <img src="/fundwaalet.webp" alt="Activate wallet" className="relative z-10 w-16 h-16" />
          </div> */}
        </div>

        {/* The component now only runs when the account is active on the network.
            At this point, if they haven't trusted USDC, we allow them to do so. */}
        <h3 className="heading-3">Trust USDC</h3>

        <p className="text-secondary max-w-xs mx-auto">
          Your wallet is activated. Add USDC to your wallet to start trading.
        </p>
        ...
        <div className="space-y-3">
          <button
            ...
            disabled={!stellarAddress || isLoading}
          >
            {isLoading ? 'Processing...' : 'Trust USDC'}
          </button>
