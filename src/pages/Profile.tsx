...
const Profile: React.FC = () => {
  ...
  return (
    <div className="bg-secondary p-4 md:p-6 lg:rounded-xl lg:max-w-7xl w-full max-w-[100vw] mx-auto space-y-6 my-4">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 relative z-10">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-(--color-text-secondary)">Manage your blockchain accounts & DEX profiles</p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3 text-xs">
            ...
            <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-(--color-bg-tertiary) border border-(--color-border)">
              ...
              <span>{connectedCount} {connectedCount === 1 ? 'Wallet' : 'Wallets'}</span>
            </div>
            <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-(--color-bg-tertiary) border border-(--color-border)">
        ...
        {!isAnyWalletConnected ? (
          ...
          <>
            ...
            <div className={`grid gap-4 ${activeTabs.length === 2 ? 'grid-cols-1 md:grid-cols-2' :
              activeTabs.length === 3 ? 'grid-cols-1 md:grid-cols-3' :
              ...
              {activeTabs.map(tab => {
                ...
                return (
                  <div
                    ...
                    className={`p-4 rounded-2xl border transition-all duration-300 cursor-pointer relative overflow-hidden group shadow-sm hover:shadow-md ${isActive
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          ...
                          <span className="text-[10px] text-(--color-text-secondary)">{details.walletId}</span>
                        </div>
                      </div>
                    ...
                    <div className="mt-3 flex items-end justify-between">
                      ...
                      <div className="text-right">
                        {pnl.change !== 0 && (
                          <span className={`text-[10px] font-black px-2 py-0.5 rounded-full flex items-center gap-0.5 border ${pnl.change >= 0
                    ...
                    >
                      {tab === 'total' ? (
                        <span className="text-[10.5px] font-medium text-brand-primary/80">Unified View</span>
                      ) : details.address ? (
                  ...
                  {(activeTab === 'dydx' || (activeTab === 'total' && dydxDataService.isReady())) && (
                    !dydxDataService.isReady() ? (
                      <div className="bg-(--color-bg-secondary) border border-(--color-border) rounded-2xl p-6 shadow-premium text-center flex flex-col items-center justify-center min-h-[280px] relative overflow-hidden group">
                        ...
                        <h4 className="font-extrabold text-base text-(--color-text-primary) tracking-tight mb-2">dYdX Performance</h4>
                        <p className="text-xs text-(--color-text-secondary) max-w-sm leading-relaxed mb-6">
                          Connect your dYdX account to view performance metrics.
                        </p>
                        <button
                          onClick={() => openModal()}
                      ...
                      <div className="bg-(--color-bg-secondary) border border-(--color-border) rounded-2xl p-4 shadow-md flex flex-col space-y-3">
                        ...
                        >
                          <div className="flex items-center gap-2">
                            ...
                            {dydxTotal === 0 && (
                              <span className="text-[10px] bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 px-2 py-0.5 rounded-full font-semibold">Empty</span>
                            )}
                          </div>
                        ...
                        {!isDydxCollapsed && (
                          <>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-5 gap-2 pt-2 text-xs">
                              ...
                              <div className="p-2.5 bg-(--color-bg-tertiary)/50 border border-(--color-border)/40 rounded-xl">
                                <span className="text-(--color-text-secondary) block text-[10px] uppercase font-semibold tracking-wider">Leverage</span>
                                <span className="font-black text-sm text-(--color-text-primary) mt-0.5 block">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-xs bg-(--color-bg-tertiary)/20 p-3 rounded-xl border border-(--color-border)/40">
                              ...
                              <div>
                                <span className="text-(--color-text-secondary) block text-[9.5px] uppercase font-semibold tracking-wider">Net Capital</span>
                                <span className="font-bold text-xs text-(--color-text-primary) mt-1 block">
                                  {portfolioUtils.formatUSD(periodStats.netCapitalChange)}
                                </span>
                              </div>
                              <div>
                                <span className="text-(--color-text-secondary) block text-[9.5px] uppercase font-semibold tracking-wider">Net Period PnL</span>
                              ...
                              <div className="flex flex-col gap-2">
                                <div className="flex items-center gap-2 flex-wrap sm:justify-end">
                                  ...
                                  <button
                                    ...
                                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold transition-all shadow-sm border border-emerald-500/30 text-emerald-600 dark:text-emerald-400 bg-emerald-500/10 hover:bg-emerald-500/20 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                                  >
                                    {isExportingStellar ? (
                                      <RefreshCw size={13} className="animate-spin shrink-0" />
                                    ) : (
                                ...
                                <>
                                  <div className="flex-1 space-y-1">
                                    <div className="flex items-center gap-2">
                                      ...
                                      <div>
                                        <h4 className="text-sm font-bold text-(--color-text-primary)">Stellar Overview</h4>
                                        <p className="text-[11px] text-(--color-text-secondary)">Valuation & outcomes</p>
                                      </div>
                                    </div>
                                    <div className="space-y-0.5 pt-1">
                                      <span className="text-[10px] uppercase font-bold text-(--color-text-secondary) tracking-wider">Wallet Balance</span>
                                  ...
                                  <div className="flex-1 w-full md:w-auto h-full flex flex-col justify-center bg-purple-950/10 border border-purple-500/10 rounded-xl p-3 space-y-2">
                                    ...
                                    <div>
                                      ...
                                      <div className="flex items-baseline gap-2 mt-0.5">
                                        <span className={`text-2xl font-black ${(stellarPnlData?.totalPnL ?? 0) >= 0 ? 'text-green-400' : 'text-red-400'
                                          }`}>
                                          {(stellarPnlData?.totalPnL ?? 0) >= 0 ? '+' : ''}
                                          {portfolioUtils.formatUSD(stellarPnlData?.totalPnL ?? 0)}
                                        </span>
                                        {totalOpeningCostBasis > 0 && (
                                          <span className={`text-sm font-bold ${adjustedStellarPnl >= 0 ? 'text-emerald-400' : 'text-rose-400'
                                            }`}>
                                    ...
                                    <div className="flex justify-between text-[9.5px] text-(--color-text-secondary) font-bold uppercase">
                                      <span className="text-emerald-400">Inflow ({((stellarPnlData?.usdcReceived / (stellarPnlData?.usdcReceived + stellarPnlData?.usdcSpent || 1)) * 100).toFixed(0)}%)</span>
                                      <span className="text-rose-400">Outflow ({((stellarPnlData?.usdcSpent / (stellarPnlData?.usdcReceived + stellarPnlData?.usdcSpent || 1)) * 100).toFixed(0)}%)</span>
                                    </div>
                                  </div>
                                </>
                              )}
                                  ...
                                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                                    <div className="p-4 bg-gradient-to-br from-purple-950/5 to-pink-950/5 border border-purple-500/10 rounded-2xl flex flex-col sm:flex-row items-center gap-4">
                                      <div className="relative flex items-center justify-center">
                                        <svg className="w-20 h-20 transform -rotate-90 select-none shrink-0" viewBox="0 0 36 36">
                                          <path
                                      ...
                                      <div className="flex-1 text-center sm:text-left space-y-1">
                                        ...
                                        <p className="text-[11.5px] text-(--color-text-secondary) leading-relaxed">
                                          Out of <span className="text-(--color-text-primary) font-bold">{stellarPnlData.tradeCount ?? 0}</span> trades,
                                          win rate <span className="text-(--color-text-primary) font-bold">{stellarPnlData.winRate ?? 0}%</span>.
                                          Disposals: <span className="text-(--color-text-primary) font-bold">{stellarPnlData.disposalCount ?? 0}</span>.
                                        </p>
                                      </div>
                                    </div>
                                    ...
                                    <div className="p-4 bg-gradient-to-br from-purple-950/5 to-pink-950/5 border border-purple-500/10 rounded-2xl flex flex-col justify-between">
                                      <div className="space-y-2">
                                        ...
                                        <div className="relative pl-6 border-l-2 border-purple-500/10 space-y-3 py-1">
                                          <div className="relative">
                                            ...
                                            <span className="text-[9.5px] uppercase font-bold text-(--color-text-secondary) block tracking-wider">First Trade</span>
                                          ...
                                          <div className="relative">
                                            ...
                                            <span className="text-[9.5px] uppercase font-bold text-(--color-text-secondary) block tracking-wider">Last Trade</span>
                                            <span className="text-xs font-bold text-(--color-text-primary) mt-0.5 block">
                                      ...
                                      <div className="flex items-center justify-between pt-3 border-t border-(--color-border)/30 text-[11px] text-(--color-text-secondary)">
                                        <span>Active Days: <span className="font-bold text-(--color-text-primary)">{stellarPnlData.activeDays ?? 0}</span></span>
                                          ...
                                          <>
                                            ...
                                            <div className="space-y-0.5 text-xs">
                                              <div className="text-(--color-text-secondary)">
                                                Asset: <span className="font-bold text-(--color-text-primary)">{stellarPnlData.bestTrade.asset ?? '—'}</span>
                                              </div>
                                              <div className="text-(--color-text-secondary)">
                                                Date: <span className="font-bold text-(--color-text-primary)">{stellarPnlData.bestTrade.date ? new Date(stellarPnlData.bestTrade.date).toLocaleDateString(undefined, { dateStyle: 'medium' }) : '—'}</span>
                                              </div>
                                            </div>
                                          </>
                                        ) : (
                                          <div className="text-xs text-(--color-text-secondary) italic pt-2">No trading data</div>
                                        )}
                                      </div>
                                    </div>
                                      ...
                                      <div className="pt-3 space-y-1">
                                        {stellarPnlData.worstTrade ? (
                                          <>
                                            ...
                                            <div className="space-y-0.5 text-xs">
                                              <div className="text-(--color-text-secondary)">
                                                Asset: <span className="font-bold text-(--color-text-primary)">{stellarPnlData.worstTrade.asset ?? '—'}</span>
                                              </div>
                                              <div className="text-(--color-text-secondary)">
                                                Date: <span className="font-bold text-(--color-text-primary)">{stellarPnlData.worstTrade.date ? new Date(stellarPnlData.worstTrade.date).toLocaleDateString(undefined, { dateStyle: 'medium' }) : '—'}</span>
                                              </div>
                                            </div>
                                          </>
                                        ) : (
                                    ...
                                    <div className="p-4 bg-gradient-to-br from-purple-500/5 to-indigo-500/5 border border-purple-500/10 hover:border-purple-500/20 rounded-2xl transition duration-300 relative overflow-hidden group">
                                      ...
                                      <div className="pt-3 space-y-1">
                                        {stellarPnlData.largestPosition ? (
                                          ...
                                          <div className="text-xs text-(--color-text-secondary) italic pt-2">No positions</div>
                                        )}
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div className="space-y-3 mt-2">
                                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-2 text-xs">
                                      ...
                                      <div className="p-2.5 bg-(--color-bg-tertiary)/50 border border-(--color-border)/40 rounded-xl flex flex-col justify-between min-h-[65px]">
                                        ...
                                        <span className={`font-black text-sm mt-1 block ${(stellarPnlData.totalRealized ?? 0) >= 0 ? 'text-green-400' : 'text-red-400'
                                          }`}>
                                      ...
                                      <div className="p-2.5 bg-(--color-bg-tertiary)/50 border border-(--color-border)/40 rounded-xl flex flex-col justify-between min-h-[65px]">
                                        ...
                                        <span className={`font-black text-sm mt-1 block ${(stellarPnlData.totalUnrealized ?? 0) >= 0 ? 'text-green-400' : 'text-red-400'
                                          }`}>
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-xs bg-(--color-bg-tertiary)/25 p-3 rounded-2xl border border-(--color-border)/40">
                                      ...
                                      <div className="space-y-0.5">
                                        <span className="text-(--color-text-secondary) block text-[9.5px] uppercase font-bold tracking-wider">Net Period PnL</span>
            ...
            {((activeTab === 'dydx' && dydxDataService.isReady()) || (activeTab === 'total' && dydxDataService.isReady())) && (
              <div id="open-margin-positions" className="w-full bg-(--color-bg-secondary) border border-(--color-border) rounded-2xl p-4 shadow-md space-y-3">
            ...
            <div className="bg-(--color-bg-secondary) border border-(--color-border) rounded-2xl overflow-hidden shadow-sm">
              <div className="p-3 border-b border-(--color-border) space-y-3 md:space-y-0 md:flex md:items-center md:justify-between gap-2">
                <div className="relative flex-1 max-w-lg">
                  <Search size={15} className="absolute left-3 top-1/2 -translate-y-1/2 text-(--color-text-secondary)" />
                  <input
                    type="text"
                    value={searchQuery}
                ...
                {availableChains.length > 0 && (
                  <div className="flex items-center gap-1.5 overflow-x-auto py-1 hide-scrollbar">
                    <button
                      ...
                      className={`px-2.5 py-1 rounded-lg text-[10.5px] font-semibold transition shrink-0 ${selectedChainFilter === 'all'
                        ? 'bg-brand text-white'
                    ...
                    {availableChains.map(chain => (
                      <button
                        ...
                        className={`px-2.5 py-1 rounded-lg text-[10.5px] font-semibold transition shrink-0 flex items-center gap-1 ${selectedChainFilter === chain.id
                          ? 'bg-brand text-white'
                          : 'bg-secondary text-(--color-text-secondary) hover:bg-(--color-bg-secondary) border border-(--color-border)'
                          }`}
                      >
                        {getChainLogoUrl(chain.id) && (
                          <img src={getChainLogoUrl(chain.id)} alt={chain.name} className="w-3 h-3 rounded-full shrink-0" />
                        )}
                        {chain.name}
                      </button>
                    ))}
                          ...
                          <div className="hidden md:grid grid-cols-4 px-4 py-3 items-center gap-3 text-sm">
                              ...
                              <div className="relative shrink-0">
                                ...
                                <div className="absolute -bottom-1 -right-1 w-4.5 h-4.5 rounded-full bg-secondary border border-(--color-border) flex items-center justify-center shadow-sm">
                                  {getChainIcon(asset) ? (
                                    ...
                                    <span className="text-[7px] font-black text-(--color-text-secondary)">{asset.chainType?.[0]?.toUpperCase()}</span>
                                  )}
                                </div>
                              </div>
                            ...
                            <div className="text-right flex flex-col items-end shrink-0">
                              ...
                              {asset.price_change_percentage_24h !== 0 && (
                                <span className={`flex items-center text-[10px] font-bold ${isPriceDown ? 'text-red-400' : 'text-emerald-400'
                                  } mt-0.5`}>
      ...
      {/* <div className="bg-(--color-bg-secondary) border border-(--color-border) rounded-2xl p-4 shadow-sm">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            <Server size={16} className="text-brand-primary" />
            <span className="font-bold text-sm text-(--color-text-primary)">Network Status</span>
          ...
          <div className="flex flex-wrap items-center gap-4 text-xs">
            <div className="flex items-center gap-1.5">
              ...
              <span className="font-semibold text-(--color-text-secondary)">Ethereum</span>
              <span className="text-(--color-text-primary)">Healthy: 156 Gwei</span>
            </div>
            <div className="flex items-center gap-1.5">
              <span className="w-2 h-2 rounded-full bg-green-500" />
              <span className="font-semibold text-(--color-text-secondary)">Stellar</span>
              <span className="text-(--color-text-primary)">Healthy: 2.1s</span>
            </div>
            <div className="flex items-center gap-1.5">
              <span className="w-2 h-2 rounded-full bg-green-500" />
              <span className="font-semibold text-(--color-text-secondary)">dYdX</span>
              <span className="text-(--color-text-primary)">Healthy: 0.8s</span>
            </div>
          </div>
        </div>
      </div> */}
