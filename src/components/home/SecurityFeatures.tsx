  ...
  const features = [
    {
      ...
      description:
        'Swiftex is a fully compliant exchange registered with the Financial Intelligence Unit (FIU).',
      icon: (
    ...
    },
    {
      ...
      description:
        'We adhere to the highest international standards for information security management.',
      icon: (
    ...
    },
    {
      ...
      description:
        'Your funds are protected with multi-layered security protocols and cold storage wallets.',
      icon: (
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className="flex flex-col items-center text-center p-8 rounded-2xl bg-bg-primary border border-border hover:shadow-lg transition-shadow"
            >
        ...
        <div className="mt-16 flex justify-center">
          <div className="bg-bg-tertiary px-8 py-6 rounded-xl flex flex-col md:flex-row items-center gap-8 border border-border">
            <div className="text-center md:text-left">
              <p className="text-sm uppercase tracking-wide text-muted font-semibold mb-1">
