        ...
        <div className="relative h-[400px] md:h-[600px] flex items-center justify-center perspective-[2000px]">
          ...
          {screens.map((screen, index) => {
            ...
            if (position === 'center') {
              ...
              transformClass =
                '-translate-x-[15%] md:-translate-x-[45%] scale-[0.8] md:scale-[0.85] -rotate-y-12';
              zIndexClass = 'z-10';
            ...
            return (
              ...
              >
                <div
                  className={`relative rounded-xl bg-gray-900  overflow-hidden ${position === 'center' ? 'ring-1 ring-white/10' : ''}`}
                >
                  {position === 'center' && (
                    <div className="h-10 bg-gray-900/95 backdrop-blur flex items-center px-4 space-x-2 border-b border-gray-800">
                      ...
                      <div className="flex-1 text-center">
                        <span className="text-xs text-gray-500 font-medium bg-gray-800 px-3 py-1 rounded-md">
                          swiftex.exchange/trade
                        </span>
                      </div>
                    </div>
                  )}
                  ...
                  {position !== 'center' && (
                    <div className="absolute inset-0 bg-gray-900/40 transition-colors"></div>
                  )}
                </div>
              </div>
            );
