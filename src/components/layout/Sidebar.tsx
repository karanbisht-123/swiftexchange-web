  ...
  return (
    <>
      <button
        ...
        className={`lg:hidden fixed top-4 left-4 z-50 p-2.5 rounded-xl transition-all duration-300 shadow-lg ${isOpen ? 'bg-secondary text-primary translate-x-[72px]' : 'bg-brand-primary text-white'
          }`}
      >
